...
from dom_processing.dom_tree_builder.tree_building.abstract_strategy import TreeBuilderStrategy
...
class RepeatTreeBuilderStrategy(TreeBuilderStrategy):
    ...
    def get_dynamic_count(self, caching_coordinator: CachingCoordinator, repeat_tag:str) -> int:
        """Get count of child elements from landmark cache"""
        # this returned 1 instead for 2, means that the container never gets cached, why?
        # Access cache handler to get current landmark
    ...
    def _get_repeat_configuration(
        ...
        count = (
            ...
            self.get_dynamic_count(caching_coordinator, template_schema["tag"])
